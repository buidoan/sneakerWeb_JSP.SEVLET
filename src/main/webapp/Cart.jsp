		...
		<div class="shopping-cart">
            <div class="px-4 px-lg-0">
                ...
                <div class="pb-5">
                    <div class="container">
                        <div class="row">
                            <div class="col l-12 m-12 c-12 p-5 bg-white rounded shadow-sm mb-5">
                        ...
                        <div class="row py-5 p-4 bg-white rounded shadow-sm">
                                ...
                                <div class="p-4">
                                    <div class="input-group mb-4 border rounded-pill p-2">
                                        ...
                                        <div class="input-group-append border-0">
                                            <button id="button-addon3" type="button" style="background-color: #fe6233" class="btn btn-dark px-4 rounded-pill"><i class="fa fa-gift mr-2"></i>Sử dụng</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                ...
                                <div class="p-4">
                                    ...
                                    </ul><a href="buy" class="btn btn-dark rounded-pill py-2 btn-block" style="background-color: #fe6233">Mua hàng</a>
                                </div>
                            </div>
                        </div>
